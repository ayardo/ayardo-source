...
official/supported Docker Images found at https://hub.docker.com/r/ayardopay/ayardod/
...
**NOTE: Please update the image description at https://hub.docker.com/r/ayardopay/ayardod-develop/ when changing the above text**