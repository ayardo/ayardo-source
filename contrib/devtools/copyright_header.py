...
Arguments:
    <base_directory> - The base directory of a Ayardo Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Ayardo Core developers'
...
Arguments:
    <base_directory> - The base directory of Ayardo Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Ayardo Core repository.
"""
