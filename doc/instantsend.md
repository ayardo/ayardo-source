...
This mechanism has been integrated into Bitcore-Node-Ayardo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ayardopay/insight-api-ayardo#web-socket-api](https://github.com/ayardopay/insight-api-ayardo#web-socket-api)
* API: [https://github.com/ayardopay/insight-api-ayardo#instantsend-transactions](https://github.com/ayardopay/insight-api-ayardo#instantsend-transactions)
