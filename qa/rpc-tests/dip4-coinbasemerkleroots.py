...
from test_framework.test_framework import AyardoTestFramework
...
class LLMQCoinbaseCommitmentsTest(AyardoTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AyardoTestFramework doesn't support this atm)
