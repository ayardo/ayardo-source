...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Ayardo address\n"
            "  payee          - Print the masternode payout Ayardo address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Ayardo address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "ayardo",               "masternode",             &masternode,             true,  {} },
    { "ayardo",               "masternodelist",         &masternodelist,         true,  {} },
    { "ayardo",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "ayardo",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
