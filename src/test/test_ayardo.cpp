...
#define BOOST_TEST_MODULE Ayardo Test Suite

#include "test_ayardo.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ayardo_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
