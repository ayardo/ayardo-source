...
2. run ayardod with -printalert or -sendalert like this:
   /path/to/ayardod -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.ayardo.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Ayardo Core:0.12.0.58/"));
